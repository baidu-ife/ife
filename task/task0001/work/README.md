...
overflow: hidden;
background: 
        url("../img/trc.gif") top right no-repeat,
...
######渐变问题
        ...
        后来发现自己还是太单纯...
        群里有同学分享了一个[制作渐变效果的链接](http://www.colorzilla.com/gradient-editor/)
...
ul {
 ...
 于是找到一个全面介绍flexbox的好文章，[MARK]( http://www.w3cplus.com/css3/a-guide-to-flexbox.html)
 日后进行测试练习~
