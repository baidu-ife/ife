...
- 实现一个浮动布局，红色容器中的蓝色容器数量随着浏览器宽度的变化而变化 ![示例1](img/task0001_4.jpg) ![示例2](img/task0001_5.jpg)
...
fork本项目，在`work`目录中创建一个以自己`Github`账号名称命名的目录，切记！！创建一个以自己`Github`账号名称命名的目录！
