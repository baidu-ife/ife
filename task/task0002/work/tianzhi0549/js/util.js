...
function test(fn, name, expect, thisArg, args){
    var result=fn.apply(thisArg, Array.prototype.slice.call(arguments, 4));
    if(result===expect){
        console.log("[PASS] %s.", name);
    }else{
        console.error("[FAIL] %s, return: %s, expect: %s.", name, result, expect);
    }
}
...
$.enter=function (selector, listener){
    var KEY_ENTER=13;
    $.on(selector, "keydown", function (e){
